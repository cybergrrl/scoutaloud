...
[extra]
film_url = """https://letterboxd.com/film/twas-the-date-before-christmas/"""
tmdb_poster_path = """/jxfXnIvMsNJrBZFi9fX9ra8lkdo.jpg"""
year = 2024
...
average_rating = 2.99
cast = ["""Robert Buckley""", """Amy Groening""", """Patrice Goodman""", """Mimi Kuzyk""", """Fabio Ricci""", """Darryl Hinds""", """Karen Waddell""", """Seán Cullen""", """Christopher Jacot""", """Ava Arrindell""", """Peter Bou-Ghannam""", """James Millington""", """Conni Miu""", """Chad Andrews""", """Percy Anane-Dwumfour""", """Jorge Molina""", """Risha Nanda""", """Nitu Thakur"""]
+++
