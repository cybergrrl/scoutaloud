...
[taxonomies]
xmas_genres = ['Drama', 'Horror', 'Global']
...
spoken_languages = ["""Norwegian""", """English""", """Polish""", """German"""]
average_rating = 3.51
cast = ["""Svein Scharffenberg""", """Gørild Mauseth""", """Zbigniew Zamachowski""", """Kari Simonsen""", """Bjarte Hjelmeland""", """Benedikte Lindbeck""", """Geir Kvarme""", """Turid Gunnes""", """Wiesława Mazurkiewicz""", """Krister Henriksson""", """Jerzy Nowak""", """Martin Dauksza""", """Arne Mathias Myren""", """Lukasz Stapf""", """Irena Kwiatkowska"""]
+++
