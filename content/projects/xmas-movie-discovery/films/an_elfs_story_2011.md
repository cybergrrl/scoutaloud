...
[taxonomies]
xmas_genres = ['Family', 'Animation', 'Fantasy', 'Science Fiction']

[extra]
film_url = """https://letterboxd.com/film/an-elfs-story/"""
tmdb_poster_path = """/mSoJW2O6WFlLl7YWxEYBsgkiAAF.jpg"""
...
average_rating = 2.42
cast = ["""Leslie Bellair""", """Brendan Dooling""", """Evie Eikhoff""", """Emma Greene""", """Tatiana Guy""", """Chadwick Halbritter""", """Matt Henson""", """Michael May""", """Shameik Moore""", """Cory Rouse""", """Todd Sayre""", """Julia Walters""", """Doug Williams"""]
+++
