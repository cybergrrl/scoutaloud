...
average_rating = 3.3
cast = ["""Jamie E. Smith""", """John Christian Graas""", """Marnette Patterson""", """Mindy Ann Martin""", """Bill Melendez""", """Phillip Lucier""", """Lindsay Benesh""", """Sean Mendelson""", """Deanna Tello""", """Matthew Slowik""", """Brittany Thornton"""]
+++
