...
[taxonomies]
xmas_genres = ['Drama', 'Hallmark', 'TV Movie', 'Fantasy']
...
average_rating = 3.2
cast = ["""Richard Thomas""", """Maureen O'Hara""", """Annette O'Toole""", """Kelsey Mulrooney""", """Robert Curtis Brown""", """Michael Ensign""", """Greg Brouwer""", """Nicole Forester""", """Lily Gibson"""]
+++
