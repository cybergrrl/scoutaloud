...
[taxonomies]
xmas_genres = ['Fantasy', 'Queer', 'Romance']
...
cast = ["""Socks Whitmore""", """Ky Mullen""", """Shane Ryan-Reid""", """Chris Spinelli""", """Raven Miles""", """Jaclyn Marfuggi""", """Leonard Zhang""", """Matthew Capitanio""", """Johnny Avila""", """Louis DeStefano""", """Johnny Mask""", """Shoko Rice""", """Frank Paras Jr.""", """Damion Damaske""", """John McCoy"""]
+++
