...
[taxonomies]
xmas_genres = ['Hallmark', 'Mystery', 'TV Movie', 'Drama', 'Romance']

[extra]
film_url = """https://letterboxd.com/film/christmas-connection/"""
tmdb_poster_path = """/tFeLk3FgGTO8LahmFdMVAWopvqW.jpg"""
year = 2017
...
average_rating = 2.89
cast = ["""Brooke Burns""", """Tom Everett Scott""", """Sophie Neudorfer""", """Micheline Marchildon""", """Adriana O'Neil""", """John B. Lowe""", """Erik Athavale""", """Gino Anania""", """Adam Hurtig""", """Kevin Ramberran""", """Rick Gensiroek""", """Jan Skene""", """Kristen Harris""", """Graham Ashmore""", """Pilar Floyd""", """Quinn Greene""", """William Whyte""", """Chris Glenat""", """Cindy Rose Myskiw""", """Steve Pacaud""", """Derek James Trapp"""]
+++
